...
class ServAppearance(models.Model):
    user_id = models.CharField(max_length=70)
    servic_id = models.AutoField(primary_key=True)
...
class ServShoppingCompany(models.Model):
    service_id = models.IntegerField(blank=True, null=True)
...
class ServStoreQuery(models.Model):
    service_id = models.IntegerField(blank=True, null=True)
...
class ServWardrobe(models.Model):
    service_id = models.IntegerField(blank=True, null=True)
...
class Service(models.Model):
    ...
    server = models.CharField(db_column='SERVER', max_length=20, blank=True, null=True)  # Field name made lowercase.
